...
def register_activation_control(
    model,
    controller,
    control_vertex=None,
    vp_map=None,
    ...
    def ca_forward(self, place_in_unet):
        ...
        def forward(
            ...
            k_cross = self.head_to_batch_dim(
                self.add_k_proj(encoder_hidden_states), out_dim=4
            )
            v_cross = self.head_to_batch_dim(
                self.add_v_proj(encoder_hidden_states), out_dim=4
            )
